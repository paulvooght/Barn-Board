...
/** This wall's tap-to-segment candidate library ({ candidates: [...] }), generated by
 *  scripts/build_candidates.py. Per-board so the Hold Manager's "Tap" tool works on
 *  whichever wall is active. Returns null data when a wall has none yet. */
export const getBoardCandidates = (boardId) => getBoardSetting(`hold_candidates_${boardId}`);
